...
<center><h2 style="border:5px solid grey; width:1230px; height:40px; background-color:turquoise;">JIKA ANDA INGIN MEMBUAT TEMPAHAN LOT KUBUR SILA PILIH DAN KLIK PADA TEMPAT YANG DISEDIAKAN </h2></center>
<table align="center">
    <tr>
        <td>
...
<center><h2 style="border:5px solid grey; width:1230px; height:40px; background-color:turquoise;">ANDA JUGA BOLEH TERUS MEMBUAT TEMPAHAN LOT KUBUR DENGAN MENGISI MAKLUMAT DI BAWAH</h2></center>
<br>
<div align="center">
...
<input type="submit" value="ADD BOOKING">
 ...
 <br>
 <center><h2 style="border:5px solid grey; width:1000px; height:40px; background-color:turquoise;">ANDA BOLEH MEMBUAT PENGESAHAN TEMPAHAN LOT KUBUR ANDA DI BAWAH</h2></center>
